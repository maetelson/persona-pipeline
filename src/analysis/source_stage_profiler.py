...
REDDIT_PIPELINE_PATH = [
    {
        "stage": "collect",
        "file_path": "run/pipeline/01_collect_all.py",
    ...
    {
        "stage": "normalize",
        "file_path": "run/pipeline/02_normalize_all.py",
    ...
    {
        "stage": "validate",
        "file_path": "run/pipeline/03_filter_valid.py",
    ...
    },
    {
        ...
        "file_path": "run/pipeline/05_label_episodes.py",
