...
def _render_report(
    ...
    lines = [
        ...
        "",
        "- `run/10_source_cli.py dry-run`: seed/query inspection without recollection.",
        "- `run/10_source_cli.py collect --source ...`: source-specific sample collection when a live check is needed.",
