...
def _build_final_overview_df(
    ...
    rows = [
        ...
        *[{"metric": metric, "value": int(stage_counts.get(metric, 0) or 0)} for metric in stage_counts],
        ...
        {"metric": "original_persona_core_coverage_pct", "value": quality_checks.get("original_persona_core_coverage_pct", 0.0)},
        {"metric": "adjusted_deck_ready_denominator_row_count", "value": quality_checks.get("adjusted_deck_ready_denominator_row_count", 0)},
        {"metric": "adjusted_deck_ready_denominator_excluded_row_count", "value": quality_checks.get("adjusted_deck_ready_denominator_excluded_row_count", 0)},
        {"metric": "adjusted_deck_ready_denominator_core_coverage_pct", "value": quality_checks.get("adjusted_deck_ready_denominator_core_coverage_pct", 0.0)},
        {"metric": "coverage_gate_metric_used", "value": quality_checks.get("coverage_gate_metric_used", "")},
        {"metric": "original_coverage_gate_status", "value": quality_checks.get("original_coverage_gate_status", "")},
        {"metric": "adjusted_coverage_gate_status", "value": quality_checks.get("adjusted_coverage_gate_status", "")},
        {"metric": "coverage_gate_passed_by_adjusted_metric", "value": quality_checks.get("coverage_gate_passed_by_adjusted_metric", False)},
        {"metric": "adjusted_denominator_policy_applied", "value": quality_checks.get("adjusted_denominator_policy_applied", False)},
        {"metric": "adjusted_denominator_policy_reason", "value": quality_checks.get("adjusted_denominator_policy_reason", "")},
        {"metric": "ambiguous_review_bucket_included_check", "value": quality_checks.get("ambiguous_review_bucket_included_check", False)},
        {"metric": "business_non_core_rows_included_check", "value": quality_checks.get("business_non_core_rows_included_check", False)},
        {"metric": "persona_core_rows_never_excluded_check", "value": quality_checks.get("persona_core_rows_never_excluded_check", False)},
        {"metric": "excluded_rows_diagnostics_visible_check", "value": quality_checks.get("excluded_rows_diagnostics_visible_check", False)},
        {"metric": "denominator_exclusion_count_by_category", "value": quality_checks.get("denominator_exclusion_count_by_category", "")},
        {"metric": "denominator_exclusion_count_by_source", "value": quality_checks.get("denominator_exclusion_count_by_source", "")},
        {"metric": "denominator_exclusion_count_by_source_tier", "value": quality_checks.get("denominator_exclusion_count_by_source_tier", "")},
        {"metric": "denominator_policy_mode", "value": quality_checks.get("denominator_policy_mode", "")},
        {"metric": "denominator_policy_version", "value": quality_checks.get("denominator_policy_version", "")},
        {"metric": "adjusted_denominator_metric_status", "value": quality_checks.get("adjusted_denominator_metric_status", "")},
